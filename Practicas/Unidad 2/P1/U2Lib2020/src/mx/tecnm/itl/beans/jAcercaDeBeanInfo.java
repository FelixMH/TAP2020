...
public class jAcercaDeBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( mx.tecnm.itl.beans.jAcercaDe.class , null ); // NOI18N
        beanDescriptor.setDisplayName ( "JAcercaDe" );
        beanDescriptor.setShortDescription (  "Componente con información Acerca De"  );//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_carrera = 11;
    ...
    private static final int PROPERTY_derechos = 23;
    private static final int PROPERTY_desarrollador = 24;
    private static final int PROPERTY_desarrollador2 = 25;
    private static final int PROPERTY_desarrollador3 = 26;
    private static final int PROPERTY_desarrollador4 = 27;
    ...
    private static final int PROPERTY_institucion = 60;
    ...
    private static final int PROPERTY_logo1 = 67;
    private static final int PROPERTY_logo2 = 68;
    private static final int PROPERTY_managingFocus = 69;
    private static final int PROPERTY_materia = 70;
    ...
    private static final int PROPERTY_nombre = 81;
    ...
    private static final int PROPERTY_universidad = 103;
    ...
    private static final int PROPERTY_version = 107;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", mx.tecnm.itl.beans.jAcercaDe.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", mx.tecnm.itl.beans.jAcercaDe.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", mx.tecnm.itl.beans.jAcercaDe.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", mx.tecnm.itl.beans.jAcercaDe.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", mx.tecnm.itl.beans.jAcercaDe.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", mx.tecnm.itl.beans.jAcercaDe.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", mx.tecnm.itl.beans.jAcercaDe.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", mx.tecnm.itl.beans.jAcercaDe.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", mx.tecnm.itl.beans.jAcercaDe.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", mx.tecnm.itl.beans.jAcercaDe.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_carrera] = new PropertyDescriptor ( "carrera", mx.tecnm.itl.beans.jAcercaDe.class, "getCarrera", "setCarrera" ); // NOI18N
            properties[PROPERTY_carrera].setPreferred ( true );
            properties[PROPERTY_carrera].setDisplayName ( "Carrera" );
            properties[PROPERTY_carrera].setShortDescription ( "Nombre de la carrera" );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", mx.tecnm.itl.beans.jAcercaDe.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", mx.tecnm.itl.beans.jAcercaDe.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", mx.tecnm.itl.beans.jAcercaDe.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", mx.tecnm.itl.beans.jAcercaDe.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", mx.tecnm.itl.beans.jAcercaDe.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", mx.tecnm.itl.beans.jAcercaDe.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", mx.tecnm.itl.beans.jAcercaDe.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", mx.tecnm.itl.beans.jAcercaDe.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", mx.tecnm.itl.beans.jAcercaDe.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_derechos] = new PropertyDescriptor ( "derechos", mx.tecnm.itl.beans.jAcercaDe.class, "getDerechos", "setDerechos" ); // NOI18N
            properties[PROPERTY_desarrollador] = new PropertyDescriptor ( "desarrollador", mx.tecnm.itl.beans.jAcercaDe.class, "getDesarrollador", "setDesarrollador" ); // NOI18N
            properties[PROPERTY_desarrollador].setPreferred ( true );
            properties[PROPERTY_desarrollador].setDisplayName ( "Desarrollador 1" );
            properties[PROPERTY_desarrollador].setShortDescription ( "Nombre del desarrollador 1" );
            properties[PROPERTY_desarrollador2] = new PropertyDescriptor ( "desarrollador2", mx.tecnm.itl.beans.jAcercaDe.class, "getDesarrollador2", "setDesarrollador2" ); // NOI18N
            properties[PROPERTY_desarrollador2].setPreferred ( true );
            properties[PROPERTY_desarrollador2].setDisplayName ( "Desarrollador 2" );
            properties[PROPERTY_desarrollador2].setShortDescription ( "Nombre del desarrollador 2" );
            properties[PROPERTY_desarrollador3] = new PropertyDescriptor ( "desarrollador3", mx.tecnm.itl.beans.jAcercaDe.class, "getDesarrollador3", "setDesarrollador3" ); // NOI18N
            properties[PROPERTY_desarrollador3].setPreferred ( true );
            properties[PROPERTY_desarrollador3].setDisplayName ( "Desarrollador 3" );
            properties[PROPERTY_desarrollador3].setShortDescription ( "Nombre del desarrollador 3" );
            properties[PROPERTY_desarrollador4] = new PropertyDescriptor ( "desarrollador4", mx.tecnm.itl.beans.jAcercaDe.class, "getDesarrollador4", "setDesarrollador4" ); // NOI18N
            properties[PROPERTY_desarrollador4].setPreferred ( true );
            properties[PROPERTY_desarrollador4].setDisplayName ( "Desarrollador 4" );
            properties[PROPERTY_desarrollador4].setShortDescription ( "Nombre del desarrollador 4" );
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", mx.tecnm.itl.beans.jAcercaDe.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", mx.tecnm.itl.beans.jAcercaDe.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", mx.tecnm.itl.beans.jAcercaDe.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", mx.tecnm.itl.beans.jAcercaDe.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", mx.tecnm.itl.beans.jAcercaDe.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", mx.tecnm.itl.beans.jAcercaDe.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", mx.tecnm.itl.beans.jAcercaDe.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", mx.tecnm.itl.beans.jAcercaDe.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", mx.tecnm.itl.beans.jAcercaDe.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", mx.tecnm.itl.beans.jAcercaDe.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", mx.tecnm.itl.beans.jAcercaDe.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", mx.tecnm.itl.beans.jAcercaDe.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", mx.tecnm.itl.beans.jAcercaDe.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", mx.tecnm.itl.beans.jAcercaDe.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", mx.tecnm.itl.beans.jAcercaDe.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", mx.tecnm.itl.beans.jAcercaDe.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", mx.tecnm.itl.beans.jAcercaDe.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", mx.tecnm.itl.beans.jAcercaDe.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", mx.tecnm.itl.beans.jAcercaDe.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", mx.tecnm.itl.beans.jAcercaDe.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", mx.tecnm.itl.beans.jAcercaDe.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", mx.tecnm.itl.beans.jAcercaDe.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", mx.tecnm.itl.beans.jAcercaDe.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", mx.tecnm.itl.beans.jAcercaDe.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", mx.tecnm.itl.beans.jAcercaDe.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", mx.tecnm.itl.beans.jAcercaDe.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", mx.tecnm.itl.beans.jAcercaDe.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", mx.tecnm.itl.beans.jAcercaDe.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_institucion] = new PropertyDescriptor ( "institucion", mx.tecnm.itl.beans.jAcercaDe.class, "getInstitucion", "setInstitucion" ); // NOI18N
            properties[PROPERTY_institucion].setPreferred ( true );
            properties[PROPERTY_institucion].setDisplayName ( "Institución" );
            properties[PROPERTY_institucion].setShortDescription ( "Nombre de la institución" );
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", mx.tecnm.itl.beans.jAcercaDe.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", mx.tecnm.itl.beans.jAcercaDe.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", mx.tecnm.itl.beans.jAcercaDe.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", mx.tecnm.itl.beans.jAcercaDe.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", mx.tecnm.itl.beans.jAcercaDe.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_logo1] = new PropertyDescriptor ( "logo1", mx.tecnm.itl.beans.jAcercaDe.class, "getLogo1", "setLogo1" ); // NOI18N
            properties[PROPERTY_logo1].setPreferred ( true );
            properties[PROPERTY_logo1].setDisplayName ( "Logo Superior" );
            properties[PROPERTY_logo1].setShortDescription ( "Establece la imagen del logotipo superior" );
            properties[PROPERTY_logo2] = new PropertyDescriptor ( "logo2", mx.tecnm.itl.beans.jAcercaDe.class, "getLogo2", "setLogo2" ); // NOI18N
            properties[PROPERTY_logo2].setPreferred ( true );
            properties[PROPERTY_logo2].setDisplayName ( "Logo Inferior" );
            properties[PROPERTY_logo2].setShortDescription ( "Establece la imagen del logotipo inferior" );
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", mx.tecnm.itl.beans.jAcercaDe.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_materia] = new PropertyDescriptor ( "materia", mx.tecnm.itl.beans.jAcercaDe.class, "getMateria", "setMateria" ); // NOI18N
            properties[PROPERTY_materia].setPreferred ( true );
            properties[PROPERTY_materia].setDisplayName ( "Materia" );
            properties[PROPERTY_materia].setShortDescription ( "Nombre de la materia" );
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", mx.tecnm.itl.beans.jAcercaDe.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", mx.tecnm.itl.beans.jAcercaDe.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", mx.tecnm.itl.beans.jAcercaDe.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", mx.tecnm.itl.beans.jAcercaDe.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", mx.tecnm.itl.beans.jAcercaDe.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", mx.tecnm.itl.beans.jAcercaDe.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", mx.tecnm.itl.beans.jAcercaDe.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_nombre] = new PropertyDescriptor ( "nombre", mx.tecnm.itl.beans.jAcercaDe.class, "getNombre", "setNombre" ); // NOI18N
            properties[PROPERTY_nombre].setPreferred ( true );
            properties[PROPERTY_nombre].setDisplayName ( "Nombre App" );
            properties[PROPERTY_nombre].setShortDescription ( "Nombre de la aplicación" );
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", mx.tecnm.itl.beans.jAcercaDe.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", mx.tecnm.itl.beans.jAcercaDe.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", mx.tecnm.itl.beans.jAcercaDe.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", mx.tecnm.itl.beans.jAcercaDe.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", mx.tecnm.itl.beans.jAcercaDe.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", mx.tecnm.itl.beans.jAcercaDe.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", mx.tecnm.itl.beans.jAcercaDe.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", mx.tecnm.itl.beans.jAcercaDe.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", mx.tecnm.itl.beans.jAcercaDe.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", mx.tecnm.itl.beans.jAcercaDe.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", mx.tecnm.itl.beans.jAcercaDe.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", mx.tecnm.itl.beans.jAcercaDe.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", mx.tecnm.itl.beans.jAcercaDe.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", mx.tecnm.itl.beans.jAcercaDe.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", mx.tecnm.itl.beans.jAcercaDe.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", mx.tecnm.itl.beans.jAcercaDe.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", mx.tecnm.itl.beans.jAcercaDe.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", mx.tecnm.itl.beans.jAcercaDe.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", mx.tecnm.itl.beans.jAcercaDe.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", mx.tecnm.itl.beans.jAcercaDe.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_universidad] = new PropertyDescriptor ( "universidad", mx.tecnm.itl.beans.jAcercaDe.class, "getUniversidad", "setUniversidad" ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", mx.tecnm.itl.beans.jAcercaDe.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", mx.tecnm.itl.beans.jAcercaDe.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", mx.tecnm.itl.beans.jAcercaDe.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_version] = new PropertyDescriptor ( "version", mx.tecnm.itl.beans.jAcercaDe.class, "getVersion", "setVersion" ); // NOI18N
            properties[PROPERTY_version].setPreferred ( true );
            properties[PROPERTY_version].setDisplayName ( "Versión" );
            properties[PROPERTY_version].setShortDescription ( "Versión de la App" );
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", mx.tecnm.itl.beans.jAcercaDe.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", mx.tecnm.itl.beans.jAcercaDe.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", mx.tecnm.itl.beans.jAcercaDe.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", mx.tecnm.itl.beans.jAcercaDe.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", mx.tecnm.itl.beans.jAcercaDe.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", mx.tecnm.itl.beans.jAcercaDe.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( mx.tecnm.itl.beans.jAcercaDe.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_ejecutar27 = 27;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_ejecutar27] = new MethodDescriptor(mx.tecnm.itl.beans.jAcercaDe.class.getMethod("ejecutar", new Class[] {})); // NOI18N
            methods[METHOD_ejecutar27].setDisplayName ( "" );
            ...
            methods[METHOD_main84] = new MethodDescriptor(mx.tecnm.itl.beans.jAcercaDe.class.getMethod("main", new Class[] {java.lang.String[].class})); // NOI18N
    ...
    private static String iconNameC16 = "/graficos/isologotipo.svg";//GEN-BEGIN:Icons
